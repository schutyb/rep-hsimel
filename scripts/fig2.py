...
primero = False
if primero:
    names = ['nev_16256_4x2_bidir', 'mel_18852_6x6_bidir']
    tiledim = [[2, 4], [6, 6]]

    data = []  # guardo los phasors de los tres casos aca
    for i in range(len(names)):
        im = tifffile.imread('/home/bruno/Documentos/Proyectos/hsimel/Paper/data/spectral/f2/'
                             + names[i] + '.lsm')
        ...
        phlib.generate_file('/home/bruno/Documentos/Proyectos/hsimel/Paper/figures/fig2/' + names[i] +
                            '.ome.tiff', aux2)
...
segundo = False
if segundo:
    dc, g, s, md, ph = tifffile.imread('/home/bruno/Documentos/Proyectos/hsimel/Paper/figures/fig2/'
                                       'nev_16256_4x2_bidir.ome.tiff')
    rgb = phlib.colored_image(ph, np.asarray([45, 180]), outlier_cut=True, color_scale=0.95)
    # abajo guardo el tiff del rgb
    phlib.generate_file('/home/bruno/Documentos/Proyectos/hsimel/Paper/figures/fig2/nev_16256_4x2_bidir', rgb)
...
plotty = True
if plotty:
    dcn, gn, sn, mdn, phn = tifffile.imread('/home/bruno/Documentos/Proyectos/hsimel/Paper/figures/fig2/'
                                            'nevo_16256_04x02.ome.tiff')
    dcm, gm, sm, mdm, phm = tifffile.imread('/home/bruno/Documentos/Proyectos/hsimel/Paper/figures/fig2/'
    ...
    rgbn = tifffile.imread('/home/bruno/Documentos/Proyectos/hsimel/Paper/figures/fig2/rgb16256')
    plt.figure(5)
    plt.imshow(rgbn)
    plt.axis('off')

    rgbm = tifffile.imread('/home/bruno/Documentos/Proyectos/hsimel/Paper/figures/fig2/rgb18852')
    plt.figure(6)
    plt.imshow(rgbm)
    plt.axis('off')
    plt.show()
